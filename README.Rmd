---
title: "Jersey City Demolitions 2018-2022: Part III"
...
In the middle of 2022 --- the same year Jersey City reported
[demolishing more housing units than any municipality in New
Jersey](https://www.nj.gov/dca/divisions/codes/reporter/2021yearly/DEMO_21.pdf)
--- the *New York Times* declared it "the [most expensive city in which
to rent a home in the United
...
Code: Vacant Land [Code: 1 ] going back to 1989 Owner Name: MORGAN POINT
DEVELOPMENT CO.,LLC, Deed Date: 2004-10-08 Old Block: 139 Old Lot: 127
...
test_jc \<-
st_read("[https://services2.arcgis.com/XVOqAjTOJ5P6ngMu/arcgis/rest/services/AddressPoints/FeatureServer/0/query?where=INC_MUNI%20%3D%20'885264'&outFields=ADD_NUMBER,ST_NAME,ST_POSTYP,PRIMENAME,FULLADDR,LST_NAME,LST_PNAME,MSAGCOMM,POST_COMM,POST_CODE,PLACE_TYPE,LONG\_,LAT&outSR=4326&f=json](https://services2.arcgis.com/XVOqAjTOJ5P6ngMu/arcgis/rest/services/AddressPoints/FeatureServer/0/query?where=INC_MUNI%20%3D%20'885264'&outFields=ADD_NUMBER,ST_NAME,ST_POSTYP,PRIMENAME,FULLADDR,LST_NAME,LST_PNAME,MSAGCOMM,POST_COMM,POST_CODE,PLACE_TYPE,LONG_,LAT&outSR=4326&f=json){.uri}")
